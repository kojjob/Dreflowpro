...
import { Download, FileText, Image, Globe, Table, Presentation, Mail, Share2, Eye } from 'lucide-react';
        ...
        <div className="flex justify-between items-center mb-4">
          ...
          <div className="flex items-center space-x-3">
            <button
              ...
              className="flex items-center space-x-2 px-4 py-2 bg-gradient-to-r from-brand-500 to-blue-500 text-white rounded-lg hover:from-brand-600 hover:to-blue-600 transition-all duration-200"
            >
      ...
      <DataAnalysisReportModal
        ...
        onExport={(format) => {
          const reportExportOptions: ExportOptions = {
            ...
            description: `Comprehensive analysis of ${fileName} with interactive visualizations and insights`
          };
          onExport(reportExportOptions);
        }}
        onShare={() => onShare && onShare({ method: 'link' })}
      />
    </div>
  );
};
